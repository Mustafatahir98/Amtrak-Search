...
/* Template Name: Nearby Amtrak Search */
    ...
    if ($dealResponse === false) {
        ...
        if ($dealResponse['http_code'] == 'HTTP/1.1 200 OK') {
            ...
            if (isset($dealData['properties'])) {
                ...
                // Include file to perform the Amtrak search
                include 'amtrak_result.php';
                error_log("Included amtrak_result.php for Amtrak search.");
